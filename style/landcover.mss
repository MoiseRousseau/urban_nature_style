...
@artificial-landuse: #ffb0b0;

@built-up-lowzoom: @artificial-landuse;
@built-up-z12: #dddddd;
@residential: #ffb0b0;      // Lch(89,0,0)
@residential-line: #b9b9b9; // Lch(75,0,0)
@retail: #ffd6d1;           // Lch(89,16,30)
@retail-line: #d99c95;      // Lch(70,25,30)
@commercial: #f2dad9;       // Lch(89,8.5,25)
@commercial-line: #d1b2b0;  // Lch(75,12,25)
@industrial: @artificial-landuse;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
...
@apron: #dadae0;
@garages: @building-fill;
@parking: @building-fill;
@parking-outline: saturate(darken(@parking, 40%), 20%);
@railway: @industrial;
@railway-line: @industrial-line;
@rest_area:  @artificial-landuse; // also services
