...
@all-road-fill: #ffffff;

@tertiary-fill: @all-road-fill;
@residential-fill: @all-road-fill;
@service-fill: @all-road-fill;
@living-street-fill: @all-road-fill;
@pedestrian-fill: @all-road-fill;
@raceway-fill: @all-road-fill;
@road-fill: @all-road-fill;
@footway-fill: @all-road-fill;
@footway-fill-noaccess: @all-road-fill;
@steps-fill: @footway-fill;
@steps-fill-noaccess: @all-road-fill;
@cycleway-fill: @all-road-fill;
@cycleway-fill-noaccess: @all-road-fill;
@bridleway-fill: @all-road-fill;
@bridleway-fill-noaccess: @all-road-fill;
@track-fill: @all-road-fill;
@track-fill-noaccess: @all-road-fill;
@platform-fill: @all-road-fill;
@aeroway-fill: @all-road-fill;
@runway-fill: @aeroway-fill;
@taxiway-fill: @aeroway-fill;
@helipad-fill: @aeroway-fill;
@access-marking: @all-road-fill;
@access-marking-primary: @all-road-fill;
@access-marking-secondary: @all-road-fill;
@access-marking-white-unpaved: @all-road-fill;
@access-marking-road: @all-road-fill;
@access-marking-living-street: @all-road-fill;

@default-casing: @all-road-fill;
